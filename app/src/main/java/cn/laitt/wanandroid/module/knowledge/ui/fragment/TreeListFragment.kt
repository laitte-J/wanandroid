...
import cn.laitt.wanandroid.module.knowledge.vm.TreeListViewModel
...
class TreeListFragment :
    MvvmFragment<FragmentTreeListBinding, TreeListViewModel, Article.DataBean.DatasBean>() {
    ...
    override fun getViewModel(): TreeListViewModel {
        if (viewModel == null) {
            viewModel = ViewModelProvider(this).get(TreeListViewModel::class.java).init(cid!!)
            return viewModel
        }
        return viewModel
    }

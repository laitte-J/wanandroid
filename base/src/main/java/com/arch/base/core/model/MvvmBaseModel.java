...
import com.arch.base.core.preference.BasicDataPreferenceUtil;
import com.arch.base.core.utils.GsonUtils;
        ...
        synchronized (this) {
            for (WeakReference<IBaseModelListener> weakListener : mWeakListenerArrayList) {
                if (weakListener.get() instanceof IBaseModelListener) {
                    ...
                    if (listenerItem != null) {
                        if (isPaging()) {
                            listenerItem.onLoadFail(this, e, new PagingResult(true, isRefresh, false));
                        } else {
                            listenerItem.onLoadFail(this, e);
                        }
                    }
                }
            }
